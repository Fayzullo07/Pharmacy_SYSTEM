  ...
  return (
    <div className="bodyyy">
      <div className="loading-container">
        ...
        >
          <defs>
            <linearGradient id="backGradient" x1="0" x2="0" y1="0" y2="1">
              ...
              <stop style={{ stopColor: "#1caffc", offset: "100%" }} />
            </linearGradient>
          </defs>
          <path
        ...
        >
          <defs>
            <linearGradient id="frontGradient" x1="0" x2="0" y1="0" y2="1">
              <stop style={{ stopColor: "#7330F9", offset: "0%" }} />
              <stop style={{ stopColor: "#287bff", offset: "100%" }} />
            </linearGradient>
          </defs>
          <path
        ...
        <p className="loading-text">E-Hisobot.com</p>
      </div>
    </div>
  );
}
