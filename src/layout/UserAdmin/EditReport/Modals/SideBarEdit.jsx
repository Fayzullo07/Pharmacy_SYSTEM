  ...
  return <div className="btn-toolbar w-100">
      <div className="btn-group btn-group-sm mx-2 w-100">
        ...
        <div className="btn-group">
          <button type="button" className={`btn btn-${shows == "4" || shows == "5" || shows == "6" || shows == "7" || shows == "8" || shows == "9" ? "primary" : "outline-primary"} btn-sm dropdown-toggle`} data-bs-toggle="dropdown" aria-expanded="false">
            Qarz oldi-berdi
          </button>
          <ul className="dropdown-menu dropdown-menu-end" >
            <li>
              <button type="button" className={`${shows == "4" && "active"} dropdown-item`}  onClick={() => setShows("4")}>
                Qarzga qilingan savdo
              </button>
            </li>

            <li>
              <button type="button" className={`${shows == "5" && "active"} dropdown-item`} onClick={() => setShows("5")}>
                Qarzga qilingan savdoni qaytarish
              </button>
            </li>

            <li>
              <button type="button" className={`${shows == "6" && "active"} dropdown-item`} onClick={() => setShows("6")}>
                Qarz berish
              </button>
            </li>

            <li>
              <button type="button" className={`${shows == "7" && "active"} dropdown-item`} onClick={() => setShows("7")}>
                Berilgan qarzni qaytarish
              </button>
            </li>

            <li>
              <button type="button" className={`${shows == "8" && "active"} dropdown-item`} onClick={() => setShows("8")}>
                Qarz olish
              </button>
            </li>

            <li>
              <button type="button" className={`${shows == "9" && "active"} dropdown-item`} onClick={() => setShows("9")}>
